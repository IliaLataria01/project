...
import com.qaprosoft.carina.demo.api.fakestoreapi.GetAllMethod;
import com.qaprosoft.carina.demo.api.fakestoreapi.PostMethod;
...
public class APISampleTest implements IAbstractTest {
    ...
    @Test
    public void getAll() {
        GetAllMethod tGetUserMethod = new GetAllMethod();
    ...
    @Test
    public void post() {
        PostMethod tPostUserMethod = new PostMethod();
